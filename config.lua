...
Config.Permission = 'admin' -- put the permission to who can have access to the command
Config.Chance = 500 -- your chance on 1 / .. to getting the screamer
Config.Every = 1 -- the chance execution attempt (in seconds)
